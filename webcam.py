...
def select_video_file():
    ...
    file_path = askopenfilename(title="Select Video File", filetypes=[("Video Files", "*.mp4 *.avi *.mov")])
...
while(True):
    ...
    frames.append(cv2.cvtColor(frame, cv2.COLOR_BGR2RGB))  # Lưu khung hình với định dạng RGB để tạo GIF
...
output_path = os.path.join('result', gif_filename)
